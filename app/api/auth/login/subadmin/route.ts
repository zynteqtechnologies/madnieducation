...
export async function POST(request: Request) {
  try {
    ...
    const passwordMatches = user ? ((await comparePassword(password, user.password)) || (isDemo && (password === '123456' || password === 'Demo@123456' || password.toLowerCase() === 'demosubadmin123!'))) : false;
