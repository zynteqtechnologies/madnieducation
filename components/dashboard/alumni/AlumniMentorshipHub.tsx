      ...
      {selectedPost ? (
        <div className="animate-in slide-in-from-right duration-500">
          ...
          <div className="bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden">
            <div className="p-10 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="space-y-3">
                <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 rounded-xl flex items-center justify-center bg-indigo-600 text-white shadow-lg shadow-indigo-200">
                        <UserCheck size={32} />
                    </div>
                    <div>
                        <h3 className="text-3xl font-black text-slate-900 tracking-tight">{selectedPost.title}</h3>
                        <p className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest flex items-center">
                            Program Identity: Mentorship Offer
                        </p>
                    </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2 space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="text-base font-medium text-slate-600 leading-relaxed bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-inner">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                        <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest border-b border-slate-100 pb-3">Session Parameters</h4>
                        
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <div className="flex items-center text-[9px] font-black text-slate-400 uppercase tracking-widest">
                                    <Users size={12} className="mr-2" /> Target Mentees
                                </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center text-[9px] font-black text-slate-400 uppercase tracking-widest">
                                    <Calendar size={12} className="mr-2" /> Availability
                                </div>
                                <p className="text-xs font-black text-slate-800 bg-amber-50 px-3 py-2 rounded-md">
                    ...
                    <div className="bg-slate-900 p-6 rounded-xl text-white space-y-4">
                         <div className="flex items-center text-[9px] font-black text-slate-400 uppercase tracking-widest">
                            <Clock size={12} className="mr-2" /> System Metadata
                        </div>
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-[9px] font-bold text-slate-500 uppercase">Offering ID</span>
                                <span className="text-[10px] font-mono text-indigo-400">{selectedPost.id.substring(0, 13)}...</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-[9px] font-bold text-slate-500 uppercase">Created On</span>
                                <span className="text-[10px] font-mono text-slate-300">{new Date(selectedPost.createdAt).toLocaleDateString()}</span>
                            </div>
                        </div>
                    </div>
                </div>
